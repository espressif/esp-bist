...
def test_cpu_stack_success(qemu_instance, target):
...
def cpu_stack_error(qemu_debug_instance, gdb_instance, test_name, test_bp, injected_value):
...
def test_cpu_stack_error(qemu_debug_instance, gdb_instance, target):
