 ...
 *
 * Identical to samples/idf/main/ulp/main.c on purpose: the companion is the
 * element under test, so it is built and run exactly as a product would. Every
 * difference between the happy path and the fault cases lives on the HP side.
 */
