 ...
 *
 * BIST override: same as IDF hal/efuse_hal.c but declares efuse_hal_read()
 * so the generic file compiles when SOC_ECDSA_SUPPORTED (esp32h2).
 * The implementation is in hal/esp32h2/efuse_hal.c.
 */
...
/* Forward declaration for SOC-specific implementation (e.g. hal/esp32h2/efuse_hal.c) */
