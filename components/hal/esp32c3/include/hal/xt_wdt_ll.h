 ...
 */
static inline void xt_wdt_ll_enable(rtc_cntl_dev_t *hw, bool enable)
{
 ...
 */
static inline bool xt_wdt_ll_check_if_enabled(rtc_cntl_dev_t *hw)
{
 ...
 */
static inline void xt_wdt_ll_set_timeout(rtc_cntl_dev_t *hw, uint8_t timeout)
{
 ...
 * @param hw Start address of the peripheral registers.
 */
static inline void xt_wdt_ll_reset(rtc_cntl_dev_t *hw)
{
 ...
 */
static inline void xt_wdt_ll_set_backup_clk_factor(rtc_cntl_dev_t *hw, uint32_t backup_clk_val)
{
 ...
 */
static inline void xt_wdt_ll_auto_backup_enable(rtc_cntl_dev_t *hw, bool enable)
{
 ...
 * @param enable True - enable, False - disable
 */
static inline void xt_wdt_ll_intr_enable(rtc_cntl_dev_t *hw, bool enable)
{
